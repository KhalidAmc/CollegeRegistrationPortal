...
<section class="grid-2">
    <form method="post" action="${pageContext.request.contextPath}/admin/courses" class="card form-stack">
        ...
        <label>Code <input name="code" required placeholder="CST8915"></label>
        <label>Title <input name="title" required placeholder="Cloud-Native Applications"></label>
        <label>Description <textarea name="description" required rows="4" placeholder="Short course description"></textarea></label>
        <label>Term <input name="term" required placeholder="Fall 2026"></label>
        <div class="form-row">
